...
public class BranchPredSampleTest {
    ...
    private static final String TRACE_FILE = "./path/streamcluster-10M-v2.trace.gz";
    ...
    @Test
    public void testNeverTakenTrace() {
        final IDirectionPredictor never = new DirPredBimodal(18);
    ...
    */
    @Test
    public void testNeverTakenTrace() {
        final IDirectionPredictor never = new DirPredGshare(18,18);
        final IBranchTargetBuffer bigBtb = new BranchTargetBuffer(18);
        InsnIterator uiter = new InsnIterator(TRACE_FILE, -1);
        IInorderPipeline pl = new InorderPipeline(1, new BranchPredictor(never, bigBtb));
        pl.run(uiter);
    ...
    @Test
    public void testNeverTakenTrace() {
        //final IDirectionPredictor never = new DirPredTournament(5,5);
        final	IDirectionPredictor always = new DirPredAlwaysTaken();
        final    IDirectionPredictor never = new DirPredNeverTaken();
        final DirPredTournament tournament = new DirPredTournament(5, never, always);
